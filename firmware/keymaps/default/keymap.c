...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_ansi(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_ALGR, MO(2),            KC_8,   KC_9
    ),
    [1] = LAYOUT_60_ansi(
    ...
    [2] = LAYOUT_60_ansi(
        ...
        _______,          _______, _______, _______, _______, _______, _______, KC_KP_4, KC_8,    KC_KP_6, _______, _______,          _______,
